...
async function startServer() {
  ...
  const FALLBACK_ANALYSIS = {
    ...
    imageHeight: 1280,
    hotspots: [
      { id: "1", x: 716, y: 960, materialName: "地面", materialType: "橡木复合地板" },
      { id: "2", x: 1024, y: 384, materialName: "墙面", materialType: "白色乳胶漆" },
      { id: "3", x: 1536, y: 768, materialName: "家具", materialType: "布艺沙发" }
    ],
    materials: [
      { id: 1, name: "橡木复合地板", type: "木地板", characteristics: "耐磨,环保,易清洁", base_price_min: 280, base_price_max: 450, install_price_min: 50, install_price_max: 80 },
      { id: 2, name: "白色乳胶漆", type: "涂料", characteristics: "净味,耐擦洗,遮盖力强", base_price_min: 35, install_price_min: 15, base_price_max: 65, install_price_max: 25 },
      { id: 3, name: "布艺沙发", type: "家具", characteristics: "舒适,易拆洗,透气", base_price_min: 3000, install_price_min: 0, base_price_max: 8000, install_price_max: 0 }
    ]
  };
  ...
  app.post("/api/generate-image", async (req, res) => {
    ...
    try {
      ...
      console.error("Image generation failed or timed out:", taskStatus);
